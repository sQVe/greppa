...
export const StackedDiffViewer = memo(
  forwardRef<StackedDiffViewerHandle, StackedDiffViewerProps>(
    ({ diffs, reviewedPaths, onToggleReviewed, onActiveFileChange }, ref) => {
      ...
      const paddingBottom = lastItem != null ? virtualizer.getTotalSize() - lastItem.end : 0;

      return (
        <div
          ref={containerRef}
          className={styles.container}
          data-testid="stacked-diff-viewer"
          onScroll={updateActiveFile}
        >
          {activeDiff != null && (
            <div
              className={styles.stickyOverlay}
